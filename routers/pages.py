...
async def save_new_rule(
    ...
    skip_draft: Optional[str] = Form(None),
    ...
    title_require_jira_prefix: Optional[str] = Form(None),
    title_forbid_cyrillic: Optional[str] = Form(None),
    title_require_release_suffix: Optional[str] = Form(None),
    title_mention_assignees: Optional[str] = Form(None),
    title_resolve_discussion_when_fixed: Optional[str] = Form(None),
    ...
    pipeline_job_name: str = Form(""),
    pipeline_mention_assignees: Optional[str] = Form(None),
    pipeline_retry_jobs: str = Form(""),
    retry_trace_marker: str = Form(""),
    retry_trace_matcher_regex: str = Form(""),
    retry_gitlab_boilerplate_suffix: str = Form(""),
    ...
    upsert_rule_aggregate(conn, {
        ...
        "title_require_jira_prefix": bool(title_require_jira_prefix),
        "title_forbid_cyrillic": bool(title_forbid_cyrillic),
        "title_require_release_suffix": bool(title_require_release_suffix),
        "title_mention_assignees": bool(title_mention_assignees),
        "title_resolve_discussion_when_fixed": bool(title_resolve_discussion_when_fixed),
        ...
        "pipeline_mention_assignees": bool(pipeline_mention_assignees),
        ...
        "retry_gitlab_boilerplate_suffix": retry_gitlab_boilerplate_suffix,
